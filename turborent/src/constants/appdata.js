...
export const links = [
  ...
  export const profile = [
    ...
    {
      title: "Quotes",
      text: "Your definitive decision for lavish or high-limit transport, whenever, at anyplace",
      icon: "quote-left",
      img: "/banner-2.jpg",
    },
    {
      title: "Inspiration",
      text: "Find our spic and span TurboRent vehicle administration, conveying unmatched class and accommodation.",
      img: "/banner-3.jpg",
      icon: "lightbulb",
    },
  ];
